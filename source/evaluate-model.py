...
from transformers import RobertaTokenizerFast, RobertaConfig, RobertaForMaskedLM, Trainer, TrainingArguments, DataCollatorForLanguageModeling
...
model.to(device)
#dataset = load_dataset("parquet", data_dir="./parquet", trust_remote_code=True, split="test[:20%]")

#tokenized_dataset = dataset.map(preprocess_function, batched=True)
#tokenized_dataset.save_to_disk("./dataset/tokenized_dataset")
tokenized_dataset = load_from_disk("./dataset_light_50000_test/tokenized_dataset")
